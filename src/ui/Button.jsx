...
function Button({ children, disabled, to, type }) {
    ...
    const styles = {
        ...
        secondary:
            base +
            'inline-block text-sm rounded-full bg-transparent border-2 border-stone-300 font-semibold uppercase tracking-wide text-stone-400 transition-colors hover:bg-stone-800  focus:ring-stone-200 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5',
    }
    if (to) {
        return (
